...
public class ScoreHandler {
     ...
     * params:
     * originalScore1: current score of player 1
     * originalScore2: current score of player 2
     * inputScore: input number from user
     * */
     ...
     * params:
     * originalScore: current players score
     * inputScore: input from user
     * scoreBoard: ScoreBoard object that should be updated
     * currentScore: TextView object of current score that should be updated
     * legCounter: TextView object of the current players legCounter that should be updated in case of a win
     * */
     ...
     * Called when there's a winner in a leg.
     * params:
     * legCounter: TextView object of the legCounter for the current player that should be updated.
     * */
